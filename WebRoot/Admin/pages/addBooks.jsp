...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function openUpload(){
		var win = window.showModalDialog("pictureUpload.jsp","","dialogWidth:300px;dialogHeight:300px;scroll:no;status:no");   
               if(win != null){   
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	...
  	<tr><td>
    	...
    	<table>
    		...
    		<tr>
				<td>图片:</td>
				<td colspan="2"><input type="file" id="picture" name="picture"/><input type="button" name="uppicture" id="uppicture" value="上传图片" onClick="openUpload()"/></td>	
			</tr>
    		<tr>
				<td>数量:</td>
